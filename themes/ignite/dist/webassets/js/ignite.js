...
/* harmony import */ var external_svg_loader__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! external-svg-loader */ "./node_modules/external-svg-loader/dist/svg-loader.min.js");
/* harmony import */ var external_svg_loader__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(external_svg_loader__WEBPACK_IMPORTED_MODULE_4__);
...
var ige = {
  ...
  sliders: function sliders() {
    var sliders = document.querySelectorAll('[data-ige-sliders]');
    ...
    if (Array.from(sliders).length > 0) {
      ...
      for (var index in sliders) {
        ...
        if (dataset) {
          var configurable = dataset.igeSliders;

          if (configurable && document.querySelector(configurable)) {
            var config = document.querySelector(configurable);

            try {
              config = JSON.parse(config.textContent);
              jquery__WEBPACK_IMPORTED_MODULE_2___default()(slider).slick(_objectSpread({
                rtl: rtl
              }, config));
              console.log(slider);
            } catch (e) {
              console.error("Slider (".concat(index, ") has been skipped, the config not valid."));
              console.error(e);
            }
          }
        }
  ...
  fixedHeader: function fixedHeader() {
    var header = jquery__WEBPACK_IMPORTED_MODULE_2___default()(".ige-header");
    var navbar = jquery__WEBPACK_IMPORTED_MODULE_2___default()(".navbar");
  ...
  collapse: function collapse() {
    var collapseItems = document.querySelectorAll('[data-ige-target="collapse"]');

    for (var collapseItemKey in collapseItems) {
      var collapseItem = collapseItems[collapseItemKey]; // Datasets

      var dataset = collapseItem.dataset;

      if (dataset) {
        (function () {
          var igeTrigger = dataset.igeTrigger,
              igeHover = dataset.igeHover,
              igeContainer = dataset.igeContainer;
          var triggers = collapseItem.querySelectorAll(igeTrigger);

          if (Array.from(triggers).length > 0) {
            var _loop = function _loop(triggerKey) {
            ...
            for (var triggerKey in Array.from(triggers)) {
              _loop(triggerKey);
            }
          }
        })();
  ...
  collapseTriggerEvent: function collapseTriggerEvent(trigger, igeHover, triggers, igeContainer, e) {
    var currentTarget = e.currentTarget;
    triggers.forEach(function (t) {
      return t.classList.remove(igeHover);
    });
    currentTarget.classList.add(igeHover); // Show content

    var dataset = trigger.dataset;

    if (igeContainer && dataset.content) {
      var container = document.querySelector(igeContainer);
...
/******/ 		var installedChunks = {
/******/ 			"/webassets/js/ignite": 0,
/******/ 			"webassets/css/ignite.rtl": 0,
/******/ 			"webassets/css/ignite": 0
/******/ 		};
/******/ 		
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkignite"] = self["webpackChunkignite"] || [];
...
/******/ 	__webpack_require__.O(undefined, ["webassets/css/ignite.rtl","webassets/css/ignite"], () => (__webpack_require__("./source/js/ignite.js")))
/******/ 	__webpack_require__.O(undefined, ["webassets/css/ignite.rtl","webassets/css/ignite"], () => (__webpack_require__("./source/scss/ignite.scss")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["webassets/css/ignite.rtl","webassets/css/ignite"], () => (__webpack_require__("./source/scss/rtl.scss")))
