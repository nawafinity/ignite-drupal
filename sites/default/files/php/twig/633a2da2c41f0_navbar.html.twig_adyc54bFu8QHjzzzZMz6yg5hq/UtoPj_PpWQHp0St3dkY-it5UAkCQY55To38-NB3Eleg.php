...
class __TwigTemplate_5ef4e09cc013b023f8720347bf5190b132d436da0fe694e2bf30059a921d9b85 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        $macros = $this->macros;
        // line 1
        $context["navbar_classes"] = ((($context["is_front"] ?? null)) ? ("bg-transparent navbar-dark") : ("navbar-light bg-white"));
        // line 2
        echo "
...
";
    ...
    {
        return new Source("{% set navbar_classes = is_front ? \"bg-transparent navbar-dark\" : \"navbar-light bg-white\" %}

<nav class=\"navbar navbar-expand-xl {% if navbar_classes %}{{ navbar_classes }}{% endif %}\">
  <div class=\"container-xl\">
    <a class=\"navbar-brand\" href=\"{{ url('<front>') }}\">
      <svg class=\"logo\" data-src=\"{{ base_path ~ directory }}/dist/webassets/images/logos/ige-logo.svg\" fill=\"currentColor\"/>
    </a>
    ...
    <div class=\"offcanvas offcanvas-start text-bg-dark\" tabindex=\"-1\" id=\"navbarContent\">
      <div class=\"offcanvas-header\">
        <h5 class=\"offcanvas-title\" id=\"offcanvasDarkNavbarLabel\">{{ \"Menu\"|t }}</h5>
        <button type=\"button\" class=\"btn-close btn-close-white\" data-bs-dismiss=\"offcanvas\"
                aria-label=\"Close\"></button>
      </div>
      <div class=\"offcanvas-body\">
        ...
        {{ page.navbar_additional_menu }}
      </div>
    </div>
  </div>
</nav>
", "@ignite/partials/navbar.html.twig", "F:\\WorkSpace\\public_html\\ignite-drupal\\themes\\ignite\\templates\\partials\\navbar.html.twig");
    }
