...
<div class=\"ige-block-initiatives__item\">
  <div class=\"card mx-2 rounded-2 overflow-hidden\">
    ";
        // line 7
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, twig_var_dump($this->env, $context, ...[0 => twig_get_array_keys_filter($this->sandbox->ensureToStringAllowed(($context["background"] ?? null), 7, $this->source))]), "html", null, true);
        echo "
...
", "themes/ignite/templates/views/views-view-fields--initiatives.html.twig", "F:\\WorkSpace\\public_html\\ignite-drupal\\themes\\ignite\\templates\\views\\views-view-fields--initiatives.html.twig");
    ...
    public function checkSecurity()
    {
        ...
        static $filters = array("trim" => 1, "striptags" => 1, "escape" => 7, "keys" => 7);
        static $functions = array("dump" => 7, "file_url" => 10);

        try {
            $this->sandbox->checkSecurity(
                ['set', 'if'],
                ['trim', 'striptags', 'escape', 'keys'],
                ['dump', 'file_url']
            );
